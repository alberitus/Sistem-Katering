...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('import/landing/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('import/landing/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('import/landing/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('import/landing/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('import/landing/vendor/aos/aos.css') }}" rel="stylesheet">
    <link href="{{ asset('import/landing/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('import/landing/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">

    <!-- Main CSS File -->
    <link href="{{ asset('import/landing/css/main.css') }}" rel="stylesheet">
</head>
...
<body class="index-page">
    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row gy-4 justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                        <img src="{{ asset('import/landing/img/hero-img.png') }}" class="img-fluid animated" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('import/landing/img/about.jpg') }}" class="img-fluid mb-4" alt="">
                    ...
                    <div class="col-lg-5" data-aos="fade-up" data-aos-delay="250">
                        <div class="content ps-0 ps-lg-5">
                            ...
                            <div class="position-relative mt-4">
                                <img src="{{ asset('import/landing/img/about-2.jpg') }}" class="img-fluid" alt="">
                                <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8"
        ...
        <section id="stats" class="stats section dark-background">
            ...
            <img src="{{ asset('import/landing/img/stats-bg.jpg') }}" alt="" data-aos="fade-in">
                    ...
                    <div class="tab-pane fade active show" id="menu-starters">
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('import/landing/img/menu/menu-item-1.png') }}" class="glightbox"><img
                                        src="{{ asset('import/landing/img/menu/menu-item-1.png') }}" class="menu-img img-fluid" alt=""></a>
                                <h4>Magnam Tiste</h4>
                                <p class="ingredients">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('import/landing/img/menu/menu-item-2.png') }}" class="glightbox"><img
                                        src="{{ asset('import/landing/img/menu/menu-item-2.png') }}" class="menu-img img-fluid" alt=""></a>
                                <h4>Aut Luia</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                                </p>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('import/landing/img/menu/menu-item-3.png') }}" class="glightbox"><img
                                        src="{{ asset('import/landing/img/menu/menu-item-3.png') }}" class="menu-img img-fluid" alt=""></a>
                                <h4>Est Eligendi</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                                </p>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('import/landing/img/menu/menu-item-4.png') }}" class="glightbox"><img
                                        src="{{ asset('import/landing/img/menu/menu-item-4.png') }}" class="menu-img img-fluid" alt=""></a>
                                <h4>Eos Luibusdam</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                                </p>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('import/landing/img/menu/menu-item-5.png') }}" class="glightbox"><img
                                        src="{{ asset('import/landing/img/menu/menu-item-5.png') }}" class="menu-img img-fluid" alt=""></a>
                                <h4>Eos Luibusdam</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                                </p>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('import/landing/img/menu/menu-item-6.png') }}" class="glightbox"><img
                                        src="{{ asset('import/landing/img/menu/menu-item-6.png') }}" class="menu-img img-fluid" alt=""></a>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('import/landing/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('import/landing/vendor/php-email-form/validate.js') }}"></script>
    <script src="{{ asset('import/landing/vendor/aos/aos.js') }}"></script>
    <script src="{{ asset('import/landing/vendor/glightbox/js/glightbox.min.js') }}"></script>
    <script src="{{ asset('import/landing/vendor/purecounter/purecounter_vanilla.js') }}"></script>
    <script src="{{ asset('import/landing/vendor/swiper/swiper-bundle.min.js') }}"></script>

    <!-- Main JS File -->
    <script src="{{ asset('import/landing/js/main.js') }}"></script>
